...
describe.skip('validaciones revisar pago ejecutivo', () => {
  beforeEach(() => {
    cy.server();
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/obtbandeja.json').as('tareaJSON');
    cy.route('POST', `${apiUrl}/obtbandeja`, '@tareaJSON');

    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/obtdetallesiniestro.json').as(
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/lstramoscoberturas.json').as(
      'ramosCoberturasJSON'
    );
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/lstpagos.json').as(
      'listaPagosJSON'
    );
    cy.route('POST', `${apiUrl}/obtpagos`, '@listaPagosJSON').as('obtpagos');

    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/obtcoordenadabancaria.json').as(
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/obtdatosinforme.json').as(
      'datosInformeJSON'
    );
    ...
    cy.fixture(
      'tareas/revisar_pago_ejecutivo_otrosConceptos/obtramoscoberturasajustadores.json'
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/obtdetallepolizaclaims.json').as(
      'detallePolizaJSON'
    );
    cy.route(
      'POST',
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/obtdetallecertificado.json').as(
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/obtdocssolicitados.json').as(
      'docsSolicitadosJSON'
    );
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/obtestadoprocesopago.json').as(
  ...
  it('el ejecutivo devuelve el pago al ajustador', () => {
    // click en tarea
    ...
    cy.route({
      ...
      onRequest(xhr) {
        ...
        expect(flagAprobacion).to.equal(false);
        expect(tipoConfirmarGestion).to.equal('A');
        expect(idCargoBpm).to.equal(7);
        expect(montoPagar).to.equal(5002);
        expect(idAjustador).to.equal(69);
  ...
  it('validaciones caso liquidacion - analizar siniestro', () => {
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/obtdetallesiniestro_liquidacion_as.json').as(
      'detalleSiniestroJSON'
    );
    cy.route(
      'POST',
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/mantener_pago.json').as(
      'mantenerPagoJSON'
    );
    cy.route({
      method: 'POST',
    ...
    cy.get('.ant-modal-content .ant-modal-confirm-content').should(
      'have.text',
      'No debe tener pagos de otros conceptos en estado observado'
    );
    cy.get('.ant-modal-content .ant-modal-confirm-btns button').click();
    cy.get('.ant-modal-content').should('not.exist');
    ...
    cy.get('.ant-modal-content .ant-modal-confirm-content').should(
      'have.text',
      'No debe haber saldo pendiente en otros conceptos para poder completar la tarea'
    );
    cy.get('.ant-modal-content .ant-modal-confirm-btns button').click();
    cy.get('.ant-modal-content').should('not.exist');
  ...
  it('validaciones caso liquidacion - revisar informe', () => {
    ...
    cy.fixture('tareas/revisar_pago_ejecutivo_otrosConceptos/obtdetallesiniestro_liquidacion_ri.json').as(
      'detalleSiniestroJSON'
    );
    cy.route(
      'POST',
