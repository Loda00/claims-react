...
class DocumentosSalvamento extends React.Component {
  state = {
    loading: null
  };

  render() {
    const { showScroll, documentsDataItem, loadingDocuments, tamanioPaginacion } = this.props;
...
export default connect()(DocumentosSalvamento);
