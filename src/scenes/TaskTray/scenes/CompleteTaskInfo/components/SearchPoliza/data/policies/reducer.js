...
} from 'scenes/TaskTray/scenes/CompleteTaskInfo/components/SearchPoliza/data/policies/actions';
...
export const getPolicies = state => state.scenes.taskTray.completeTaskInfo.components.searchPoliza.data.policies;
